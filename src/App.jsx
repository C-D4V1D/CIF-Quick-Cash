...
export default function App() {
  ...
  const navItems = [
    ...
    { id: 'actionLoans', label: 'Action Loans', icon: '🚨', path: PAGE_PATHS.actionLoans, roles: ['staff', 'admin'] },
    ...
    switch (page) {
      ...
      case 'actionLoans': {
        ...
        return (
          <div>
            {listLoadingNotice}
            <h2 style={{ fontSize: '20px', fontWeight: 800, marginBottom: '8px', color: COLORS.primaryDark }}>🚨 Action Loans</h2>
            ...
            <div style={{ ...S.grid3, marginBottom: '20px' }}>
              <div style={{ ...S.stat, background: allActionLoans.length > 0 ? '#fef3c7' : COLORS.primaryLight }}>
                <div style={S.statLabel}>Action Loans</div>
        ...
        <div style={{ paddingBottom: hasUnsaved ? '80px' : 0 }}>
          ...
          <div style={S.card}>
            ...
            <div style={S.grid2}>
              ...
              <Field label={<span style={{ display: 'inline-flex', alignItems: 'center' }}>Due-Date Follow-Up Days<InfoIcon tip="Comma-separated day offsets for when the Deadlines & Alerts follow-up page should show a loan before its customer due date. Example: 3, 1, 0" /></span>}>
