    ...
    const handleSave = async () => {
      ...
      if (!isTopUp) {
        if (accountMode === 'existing' && selectedUserId) {
          ...
          if (existingUser && existingUser.role !== 'stakeholder' && !(existingUser.roles || []).includes('stakeholder')) {
